...
<img src="/1 lesson/img/01.PNG" alt="Alt text"/>

#### Таблица адресации (цвета выставлены в соответствии с цветами зон в лабораторной работе)
...
#### Настрока маршрутизатора R13 (R28 настроен по аналогии, но со своими вланами)
